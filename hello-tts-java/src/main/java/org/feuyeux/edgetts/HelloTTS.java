...
import org.feuyeux.edgetts.tts.Voice;
...
public class HelloTTS {
    ...
    private static void runTTSConversion(CommandLine cmd) throws Exception {
        ...
        try {
            ...
            log.info("✓ Audio generated successfully! Size: {} bytes", audioData.length);
    ...
    private static String findVoiceByLanguage(String languageCode, String fallbackVoice) {
        try {
            ...
            if (!matchingVoices.isEmpty()) {
                ...
                log.info("Found voice for language '{}': {}", languageCode, selectedVoice.getName());
